  ...
  return (
    <div className="grid min-h-screen md:grid-cols-2">
      ...
      <div className="flex flex-col px-5 py-6 sm:px-10 md:justify-center lg:px-20">
        <Link href="/" className="w-fit text-[14px] font-bold text-[#167C5A]">← Back home</Link>
        <div className="mt-4"><Logo /></div>
        <h1 className="mt-6 text-[28px] font-extrabold leading-tight text-[#0F5132]">{title}</h1>
      ...
      <div className="relative hidden overflow-hidden bg-[#DDF5EA] p-12 text-[#0F5132] md:flex md:flex-col md:justify-center">
        <div className="pointer-events-none absolute -right-20 -top-20 h-64 w-64 rounded-full bg-white/60 blur-3xl" />
        <div className="relative max-w-sm">
          <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#167C5A] text-2xl text-white">✓</span>
