...
export function sampleTransactions(businessId = "biz_demo"): Transaction[] {
  const raw: Omit<Transaction, "id" | "created_at" | "business_id">[] = [
    ...
    { type: "income", description: "Shoe sales", amount: 25000, category: "Sales", transaction_date: iso(2), payment_status: "pending", payment_method: "Cash", customer_or_vendor: "Chidi", notes: "Pay Friday", source: "manual" },
    ...
    { type: "income", description: "Aso-ebi order", amount: 75000, category: "Sales", transaction_date: iso(8), payment_status: "credit", payment_method: "Other", customer_or_vendor: "Funmi", notes: "", source: "manual" },
